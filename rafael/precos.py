...
def weekly_price(df = pd.read_csv(r"rafael\Dados\all_sales.csv")):
    ...
    return prices,mean_week

#salvando dados
prices,mean_week = weekly_price()
prices.to_csv(r'rafael\Dados\weekly_price.csv')
mean_week.to_csv(r'rafael\Dados\mean_sales.csv')